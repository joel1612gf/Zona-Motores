...
const userProfiles: Record<string, UserProfile> = {
  ...
  user5: {
    uid: 'user5',
    displayName: 'Concesionario VZLA',
    isVerified: true,
    phone: '+584125552222',
    accountType: 'dealer',
...
export const vehicles: Vehicle[] = [
  ...
  },
  {
    ...
    isSignatory: true,
    acceptsTradeIn: false,
    description: 'Mitsubishi Montero Dakar, una camioneta robusta y confiable. Perfecta para la familia y viajes largos. Único dueño.',
  ...
  },
  {
    ...
    isSignatory: true,
    acceptsTradeIn: false,
    description: 'Económico y guerrero Fiat Uno. Ideal para la ciudad y el día a día. Motor y caja en buen estado.',
  ...
  },
  {
    ...
    isSignatory: true,
    acceptsTradeIn: false,
    description: 'Fiat Palio en buenas condiciones. Un carro práctico y espacioso para su tamaño. Verlo es comprarlo.',
