...
import { LogIn, LogOut, User as UserIcon, Loader2, List, Store, Heart } from 'lucide-react';
          ...
          {mode === 'signUp' && signUpStep === 'type' ? (
            ...
            <>
              <DialogHeader className="relative">
                 <Button variant="ghost" size="sm" className="absolute left-0 top-0 p-0 h-auto self-start" onClick={() => setSignUpStep('type')}>
                    &larr; Volver
                </Button>
                <DialogTitle className="font-headline text-2xl text-center pt-8">
